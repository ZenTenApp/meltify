// Package main provides the meltify-monero CLI executable.
package main
...
func main() {
	...
	if err := cryptonote.ExecuteMonero(os.Args[1:], os.Stdin, info); err != nil {
		fmt.Fprintln(os.Stderr, "meltify-monero: "+err.Error())
		os.Exit(1)
	}
}
