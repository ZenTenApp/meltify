...
// moneroLegacyWordlist is the official Monero English legacy (Electrum-style) wordlist.
// Source: https://github.com/monero-project/monero/blob/master/src/mnemonics/english.h
// 1,626 words; prefix length = 3 (first 3 chars of each word are unique within the list).
var moneroLegacyWordlist = [1626]string{
